...
public class DeliveryRequestDTO {
	 ...
	 * Delivery properties.
	 */
	private List<tn.wevioo.packager.dto.delivery.DeliveryPropertyDTO> properties = new ArrayList<tn.wevioo.packager.dto.delivery.DeliveryPropertyDTO>();

	/**
	 * Delivery receiver.
	 */
	private tn.wevioo.packager.dto.delivery.ReceiverContactDTO receiver;
	...
	public List<tn.wevioo.packager.dto.delivery.DeliveryPropertyDTO> getProperties() {
		return properties;
	}

	public void setProperties(List<tn.wevioo.packager.dto.delivery.DeliveryPropertyDTO> properties) {
		this.properties = properties;
	}

	public tn.wevioo.packager.dto.delivery.ReceiverContactDTO getReceiver() {
		return receiver;
	}

	public void setReceiver(tn.wevioo.packager.dto.delivery.ReceiverContactDTO receiver) {
