...
public class FDeliveryRequest {
	 ...
	 * Delivery properties.
	 */
	private List<tn.wevioo.facade.delivery.FDeliveryProperty> properties = new ArrayList<tn.wevioo.facade.delivery.FDeliveryProperty>();

	/**
	 * Delivery receiver.
	 */
	private tn.wevioo.facade.delivery.FReceiverContact receiver;
	...
	public List<tn.wevioo.facade.delivery.FDeliveryProperty> getProperties() {
		return properties;
	}

	public void setProperties(List<tn.wevioo.facade.delivery.FDeliveryProperty> properties) {
		this.properties = properties;
	}

	public tn.wevioo.facade.delivery.FReceiverContact getReceiver() {
		return receiver;
	}

	public void setReceiver(tn.wevioo.facade.delivery.FReceiverContact receiver) {
