 ...
 * @since 2.0.0
 */
public class FProductModel {

	/**
	 * The attribute key contains the key under which is known the product model from the outside projects. This key is
	 * supposed to be unique and could be considered as another primary key of the model.
	 * <p>
	 * The value of this attribute could be set to null if the product model is desactivated from the database
	 * (desactivated does not mean deleted).
	 */
	private String key;
