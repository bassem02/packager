...
/**
 * The class ActionPackagerHeader allows storing in database packager information related to a packager action. The data
 * contained in this class are not dependent from the packager they come from, which can be modified after the action
 * has been stored.
 * 
 * @author bflorea
 * @since 2.6.2
 */
public class FActionPackagerHeader {

	/**
	 * Retailer packager identifier corresponding to the packager instance related to the action.
	 */
