...
public class FDeliveryDemand {
	 ...
	 *Delivery properties.
	 */
	private List<FDeliveryProperty> properties;

	/**
	 * Delivery receiver.
	 */
	private FReceiverContact receiver;
	...
	public List<FDeliveryProperty> getProperties() {
		return properties;
	}

	public void setProperties(List<FDeliveryProperty> properties) {
		this.properties = properties;
	}

	public FReceiverContact getReceiver() {
		return receiver;
	}

	public void setReceiver(FReceiverContact receiver) {
