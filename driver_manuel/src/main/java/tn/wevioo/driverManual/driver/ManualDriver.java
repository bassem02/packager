...
public class ManualDriver extends ProductDriverImpl<ManualConfiguration, ManualInternalConfiguration> {
	...
	public List<tn.wevioo.driverManual.tools.Reference> getReference(String ppid) throws DriverException {
		...
		List<tn.wevioo.driverManual.tools.Reference> references = new ArrayList<tn.wevioo.driverManual.tools.Reference>();
		references.add(new tn.wevioo.driverManual.tools.Reference(ReferenceKeys.PROVIDER_PRODUCT_ID, ppid));
		references.add(new tn.wevioo.driverManual.tools.Reference(ReferenceKeys.DISCRIMINATOR, ppid));
		LOGGER.info("Product references returned successfully !");
